...
class ContainerViewController: UIViewController {
    ...
    lazy var settingsViewController: ContainerSettingsViewController = {
        ...
        let viewController = storyboard.instantiateViewController(withIdentifier:
            "ContainerSettingsViewController") as! ContainerSettingsViewController
    ...
    lazy var informationViewController: ContainerInformationViewController = {
        let storyboard = UIStoryboard(name: "Main", bundle: Bundle.main)
        let viewController = storyboard.instantiateViewController(withIdentifier:
            "ContainerInformationViewController") as! ContainerInformationViewController
    ...
    override func viewDidLoad() {
        ...
        let img = UIImage(named: "containerBackground@2x.png")
    ...
    func addBottomBorder(to subview: UIView) {
        ...
        let height = 1.5
        let yPosition = Double(subview.frame.height) - height
        border.frame = CGRect(x: 0, y: yPosition, width: Double(subview.frame.width), height: height)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == openLogsSegue {
            if let logsView = segue.destination as? LogsViewController {
